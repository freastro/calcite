...
class JdbcSequence extends JdbcTable implements Sequence {
  ...
  JdbcSequence(JdbcSchema jdbcSchema, String jdbcCatalogName, String jdbcSchemaName,
      String sequenceName, SqlTypeName sequenceType, int increment) {
  ...
  @Override public String toString() {
    return "JdbcSequence {" + jdbcTableName + "}";
  }
